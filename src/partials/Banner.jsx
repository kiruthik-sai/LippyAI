...
function Banner() {
  ...
  const bannerLink = 'https://marvistanotary.com/'
  return (
    <>
    { bannerOpen && (
      <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50">
        <div className="bg-slate-800 border border-transparent dark:border-slate-700 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
          <div className='text-slate-500 inline-flex'><a className="font-medium hover:underline text-slate-50" href={bannerLink} target='_blank'>Mar Vista<span className="hidden sm:inline" > Notary</span></a> </div>
