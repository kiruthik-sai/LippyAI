...
import logoCall from '../images/logoCall.svg';
...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <div>
      ...
      {/* Logo */}
      <NavLink end to="/" className="flex items-center justify-between w-full">
        <img src={logoCall} alt="icon" width={30} height={30} />
        <span className="text-white text-2xl montserrat pr-7">LIPPY AI</span>
      </NavLink>
    </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Navigate</span>
            </h3>
            <ul className="mt-3">
              {/* Home */}
