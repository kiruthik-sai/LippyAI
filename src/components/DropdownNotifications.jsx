...
function DropdownNotifications({
  ...
  const [notificationPending, setNotificationPending] = useState(true);
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        ...
        {notificationPending ? <div className="absolute top-0 right-0 w-2.5 h-2.5 bg-rose-500 border-2 border-white dark:border-[#182235] rounded-full"/> : null}
      </button>
